...
##############################################################################
# C4 = utils.get_sine_wave(note_freqs['G4'], 2, amplitude=2048)  # Middle C
c4 = utils.get_sine_wave(note_freqs['c4'], 8, amplitude=2048)  # C sharp/D flat
wavfile.write('data/minor_seconds.wav', rate=44100, data=((c4)).astype(np.int16))
